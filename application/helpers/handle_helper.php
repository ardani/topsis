...
if (!function_exists('backHandle')) {
    function backHandle()
    { // nama fungsinya juga bisa d ganti "suka-suka lo" XD (y)
        $CI =& get_instance();
...
function genbutton($type, $status = "y", $url = "javascript:void(0);", $icon = "", $class = "")
{
    switch ($type) {
        case "P":
            return ($status == "y") ? "<a href='$url' id='bprint' class='btn $class'><i class='icon icon-print $icon'></i> print</a>" : "";
            break;

        case "C":
            return ($status == "y") ? "<button type='submit' id='bcreate' class='btn btn-primary $class'><i class='icon icon-plus $icon'></i> save data</button>" : "";
            break;

        case "D":
            return ($status == "y") ? "<a href='$url' id='bdelete' class='$class btn btn-inverse'><i class='icon icon-remove $icon'></i> del</a>" : "";
            break;

        case "U":
            return ($status == "y") ? "<a href='$url' id='bupdate' class='$class btn btn-danger'><i class='icon icon-ok $icon'></i> edit</a>" : "";
            break;
